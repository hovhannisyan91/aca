...
1. How does Tableau differ from Excel or Power BI in the way it connects to and visualizes data?  
2. Which chart types do you find most intuitive for understanding business patterns?  
3. What data sources would you most likely use in your future Tableau projects?
...
**Videos**
1. [Introduction to Tableau for Beginners](https://www.youtube.com/watch?v=9O8s2u9n0y0)  
2. [How to Build Dashboards in Tableau](https://www.youtube.com/watch?v=52d1jQmLjbA)

**Book**
- *The Big Book of Dashboards* — Steve Wexler, Jeffrey Shaffer, and Andy Cotgreave
