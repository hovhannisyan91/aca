...
## Hands-On Task — Session 01

In this task, you will apply the concepts learned in this session to build your first interactive Tableau dashboard using the **Airbnb dataset**.

---

### Objective

Create a simple dashboard that answers basic business questions using visualizations and interactivity.
...
Create at least **three different charts**:

**1. Bar Chart**

- Show distribution of listings by **Property Type**

**2. Line Chart**

- Show how listings changed over time using **Host Since**
...
- Create a **filter** (e.g., Neighbourhood or Room Type)  
- Display the filter on the worksheet or dashboard  

Optional:

- Apply **sorting** to improve readability  
- Create a **group or set** for additional segmentation  

### Step 4: Build a Dashboard

- Create a new dashboard  
- Add all created visualizations  
- Arrange them in a clean and readable layout  

### Step 5: Improve Usability

- Add clear **titles** to each chart  
- Ensure tooltips display useful information  
- Apply basic formatting for readability  

### Step 6: Publish

- Publish the dashboard to **Tableau Public**  
- Ensure it is accessible via a public link  

---

### Bonus Challenge (Optional)

- Add a second filter (e.g., Price range)  
- Create a **Top N set** (Top 10 listings by reviews)  
- Customize tooltips with additional fields  
