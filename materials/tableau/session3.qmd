...
![Date Foematting Action 1](../../img/tableau/w3_date_formatting_1.png)

![Date Foematting Action 2](../../img/tableau/w3_date_formatting_2.png)
...
![Datepart](../../img/tableau/w3_datepart.png) 
...
```
![Expected Delivey Date](../../img/tableau/w3_expected_delivery_date.png) 
...
```
![Filtering Last 12 Months](../../img/tableau/w3_filtering_last_12_months.png) 
...
![Sign Up, First Order](../../img/tableau/w3_sign_up_first_order.png) 
...
![Year Grouping](../../img/tableau/w3_year_grouping.png) 
...
![Order Week](../../img/tableau/w3_order_week.png) 
...
![Order Day](../../img/tableau/w3_order_day.png) 
...
MAKEDATE(2026, 1, 1)
```
![Reporting Date](../../img/tableau/w3_reporting_date.png) 
...
![Custom Date](../../img/tableau/w3_custom_date.png) 
...
Instead of using a quick filter with a slider, you can create:

- Start Date parameter  
- End Date parameter  

These parameters are referenced in a Boolean calculation such as:
...
- One unified date control across multiple data sources.
- More advanced logic inside calculations.
- Custom behavior beyond simple filtering.
...
depending on the selected parameter value or selected date range.

This is typically achieved by:

- DATETRUNC → to adjust the aggregation level  

By using this approach, the visualization adapts automatically to the selected time span.

For doing this we need.

**Step 1**

Create a parameter and name it **Date Granula**. The data type should be **string** and values: **day, week, quarter, month, year**.

![Date Parameter](../../img/tableau/w3_date_granularity.png) 

**Step 2**



#### 4. Multi-Source Dashboards

When working with multiple data sources, each source has its own date field.

Using quick filters would require:

- One filter per data source.

Using Date parameters allows:

- A single Start Date parameter.
- A single End Date parameter.
- Separate calculated filters in each source referencing the same parameters.

This creates a seamless user experience on dashboards.

---

### Technical Characteristics

- Date parameters store a single date value.
- They can be configured to allow all values, a list, or a range.
- They can be shown as a date picker on dashboards.
- They must be used inside calculated fields to affect data.

They do not inherently create a date hierarchy and do not automatically aggregate data. Their power comes from how they are used inside logic.

---

### Advantages

Date parameters provide:

- Cross–data-source control.
- Advanced analytical flexibility.
- Dynamic time logic.
- Cleaner dashboards (fewer filters).
- Greater customization than built-in filters.

---

### Limitations

- They do not automatically filter data.
- They require calculated fields to function.
- They must be manually synchronized with logic.
- Incorrect logic can produce misleading results.

---

### Best Practices

- Always set meaningful default values.
- Clearly label parameter controls.
- Use Boolean calculations for filtering.
- Combine with DATEDIFF and DATETRUNC for dynamic aggregation.
- Test edge cases (very short or very long date ranges).

---

### Summary

Date parameters are advanced control mechanisms in Tableau that allow users to dynamically influence time-based logic across worksheets and data sources.

They are not simply filters.  
They are analytical drivers.

By combining Date parameters with calculated fields and date functions, you can build:

- Custom date range filters  
- Dynamic KPIs  
- Adaptive time axes  
- Multi-source dashboards  
- Sophisticated time-series analytics  

They are a foundational concept for building professional, flexible Tableau dashboards.
...
![Union](../../img/tableau/w3_union.png)

![Union Details](../../img/tableau/w3_union_details.png)
...
![Relationship Calculations](../../img/tableau/w3_relationship_calculation.png)

Now we have a working relationship between two tables.

![Spatial Relationship](../../img/tableau/w3_spatial_relationship.png)
...
![Spatial Join](../../img/tableau/w3_spatial_join.png)
...
![Location Hierarchy](../../img/tableau/w3_location_hierarchy.png)
...
![Simple Map](../../img/tableau/w3_simple_map.png)
...
![Polygons](../../img/tableau/w3_polygons.png)
...
![Lines](../../img/tableau/w3_lines.png)
...
![Map with layers](../../img/tableau/w3_map_with_layers.png)
...
![Proportional Symbol Map](../../img/tableau/w3_proportional_symbol_map.png)
...
![Density Map](../../img/tableau/w3_density_map.png)
