---
title: "Session 01: Introduction to Tableau"
...
::: {.callout-tip title = 'Datasets'}

Throughout those sessions we will use many tables, and you can download them from [here](https://github.com/hovhannisyan91/tableau-analytics-portfolio/tree/main/database/data)

During this particular session we are going to work with the [airbnb excel file](https://github.com/hovhannisyan91/tableau-analytics-portfolio/tree/main/database/data/airbnb.xlsx)
...
Remember to review [Intro to Data Visualization](https://hovhannisyan91.github.io/aca/materials/python/session05.html) Session 
...
![]({{< meta image_path >}}/w1_animations.gif)
...
In case of issues checkout the more detailed guide [here](https://hovhannisyan91.github.io/aca/materials/lab/tableau.html)
...
2. In Tableau Desktop select: `File → Save to Tableau Public`
...
![]({{< meta image_path >}}/w1_tableau_desktop.png)


### Tableau Server

![]({{< meta image_path >}}/w1_tableau_server.png)


### Tableau Data Prep

![]({{< meta image_path >}}/w1_tableau_data_prep.png)
...
For more information check out [official Tableau Website](https://www.tableau.com/learn/certification)
...
This is the main professional certification for analysts. Tableau describes the credential as validating core Tableau knowledge and development skills for people working with Tableau products. :contentReference[oaicite:2]{index=2}
...
1. **Tableau Desktop Foundations:**  Start here if the person is new to Tableau.
2. **Tableau Data Analyst:** Best target for data analysts, BI analysts, and dashboard developers.
3. **Tableau Consultant:** Useful if the person designs Tableau solutions for business units or clients. For platform/admin roles, the path is different:
4. **Tableau Server Administrator:**  For managing Tableau Server environments.
5. **Tableau Architect:** For enterprise-level Tableau infrastructure and architecture.
...
::: {.callout-tip title = "The key idea!"}
...
Checkout [this video](https://www.youtube.com/watch?v=QEptXC972PU&t=187s)
...
Checkout the [this video](https://www.youtube.com/watch?v=7aXQhkHIN-E)
...
1. Have Tableau Public account
2. Save the Tableau Workbook **properly**
...
## Dynamic Visualization Teaser


A **dynamic visualization** changes automatically based on data updates, time, parameters, calculations, or predefined logic.

The user does not always need to click or filter manually. The visualization can update because the underlying data or conditions change.

::: {.callout-important title = "The key idea"}

> The visualization changes automatically when the data or logic changes.
:::

> We are going to touch this part in the comming sessions
...
3. **Add one filter** filter by **Property Type** or **Room Type**
4. **Format your workbook:**
   - Apply consistent fonts and colors
   - Format **Price** as currency
5. **Build a dashboard:** combine all three charts into a single view
6. **Publish** to Tableau Public
7. Submit your public link to `#homework` channel
...
[Tableau Course Code Repository](https://github.com/hovhannisyan91/tableau-analytics-portfolio/tree/main/session01) for this session is available in the GitHub repository linked above. It includes:
...
3. [Modern Analytics Workflow](https://help.tableau.com/current/blueprint/en-us/bp_modern_analytics_workflow.htm)
4. [Tips](https://www.flerlagetwins.com/2023/02/ten-tips-techniques-including-easy-way.html)
5. [Groups](https://help.tableau.com/current/pro/desktop/en-us/sortgroup_groups_creating.htm)
