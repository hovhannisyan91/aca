...
![Running Total Example]({{< meta image_path >}}/w2_running_total.png)

![Difference Caalculation Example]({{< meta image_path >}}/w2_difference_calculation.png)
...
![Rank: The direction of movement]({{< meta image_path >}}/w2_rank_movement.png)

![Rank: Specific Dimension]({{< meta image_path >}}/w2_rank_specific_dimension.png)
...
![Marks Card Table Calculation]({{< meta image_path >}}/w2_marks_card_calculation.png)
...
![Year over Year Growth Calculation]({{< meta image_path >}}/w2_year_over_year_growth_cal.png)

![Year over Year Growth]({{< meta image_path >}}/w2_year_over_year_growth.png)
...
![Moving Average Example]({{< meta image_path >}}/w2_moving_average.png)
