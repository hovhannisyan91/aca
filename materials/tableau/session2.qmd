...
### Purpose
A **Histogram** is used to analyze the **distribution of a continuous numeric variable** by grouping values into ranges (bins) and counting how many records fall into each range.
