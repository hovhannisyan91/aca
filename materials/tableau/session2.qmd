...
## Session 2 Task: Intermediate Sales & Customer Analysis Dashboard

### Step 1: Data Modeling

Using the provided dataset:

- Use **relationships** as the main data modeling approach  
- Ensure correct connections between:
...
```sql
IF COUNTD([Order ID]) >= 3 THEN "Repeat"
ELSE "New"
END
```

### Step 3: LOD Expression

Create a customer-level metric:
...
- Compare individual orders vs total customer value  
...
- Order Date filter (Relative date → last 1 year)  
- Add Region as a **Context filter**  

#### Validation

- Observe how filters impact:
  - Aggregations  
  - LOD calculations  
...
Use it in Top filter:

- Top [Top N] Customers by SUM(Order Total)  
...
- Scatter plot → Customer (Orders vs Revenue)  
