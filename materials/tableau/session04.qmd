...
## Step 1 — Build Customer KPI Section
...
A professional customer dashboard should:

- Guide user attention
- Prioritize important customer insights
- Reduce clutter
- Maintain visual consistency
- Support storytelling
- Simplify customer analysis

The dashboard should feel analytical, structured, and presentation-ready.
...
Every dashboard element should support customer analysis and decision-making.
...
- KPI section visually dominant
- Customer insights easy to identify
- Segments clearly distinguishable
- Retention analysis readable
- Filters functional
- Typography consistent
- Colors balanced
- Layout spacing clean
- Dashboard presentation-ready
