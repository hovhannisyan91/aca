...
- Spatial files such as **Shapefile (`.shp`), GeoJSON, KML**
...
<!-- TODO: Add more details about the datasets -->
...
![Relationship Calculations]({{< meta image_path >}}/relationship_calculation.png)

Now we have a working relationship between two tables.

![Spatial Relationship]({{< meta image_path >}}/spatial_relationship.png)
...
![Spatial Join]({{< meta image_path >}}/spatial_join.png)
...
- Longitude always goes to: Columns (`X-axis`)
- Latitude always goes to: Rows (`Y-axis`)
...
![Location Hierarchy]({{< meta image_path >}}/location_hierarchy.png)
...
![Simple Map]({{< meta image_path >}}/simple_map.png)
...
![Polygons]({{< meta image_path >}}/polygons.png)
...
![Lines]({{< meta image_path >}}/lines.png)
...
![Map with layers]({{< meta image_path >}}/map_with_layers.png)
...
![Proportional Symbol Map]({{< meta image_path >}}/proportional_symbol_map.png)
...
![Density Map]({{< meta image_path >}}/density_map.png)
...
[Tableau Course Code Repository](https://github.com/hovhannisyan91/tableau-analytics-portfolio/tree/main/session07) for this session is available in the GitHub repository linked above. It includes:
