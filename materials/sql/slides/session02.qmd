...
format:
  revealjs: 
    ...
    footer: "<a href=\"../session02.qmd\" target= _blank>Back to chapter target</a>"
...
![!]({{< meta image_path >}}/erd_simple.png)

## Sales Analytics Database {.smaller}
...
## Questions to Data Analyst {.smaller}
...
![!]({{< meta image_path >}}/erd_extanded.png)
...
![!]({{< meta image_path >}}/fk_sales_vs_products.png)


## Indexes

![!]({{< meta image_path >}}/index.png)
...
## PostGIS (Geospatial Extension) {.smaller}
...
![.]({{< meta image_path >}}/snowflake_schema.png)

---

## Entity Relationship Diagram (ERD) {.smaller}
...
![.]({{< meta image_path >}}/generate_erd.png)
