...
![]({{< meta image_path >}}/rdbms.png){width="85%"}


## NoSQL Databases {.smaller}

![]({{< meta image_path >}}/document.png){width="85%"}
...
![]({{< meta image_path >}}/graphdb.png){width="85%"}
...
![]({{< meta image_path >}}/OLAPvsOLTP.png){width="85%"}


## Centralized Databases {.smaller}

![]({{< meta image_path >}}/centralized_vs_distributed.png){width="85%"}
...
![]({{< meta image_path >}}/dw.png){width="85%"}



## Data Mart (DM) {.smaller}

![]({{< meta image_path >}}/dm.png){width="85%"}



## Data Lake (DL) {.smaller}

![]({{< meta image_path >}}/dl.png){width="85%"}



## Data Lakehouse (DLH) {.smaller}

![]({{< meta image_path >}}/dlh.png){width="85%"}



## Data Management Architectures — Summary {.smaller}
