...
## Why Temporary Tables Exist {.smaller}
...
## What Is a Temporary Table? {.smaller}
...
## Creating a Temporary Table {.smaller}
...
## Example: Order-Level Revenue {.smaller}
...
## Inspecting Temporary Tables {.smaller}
...
## Reusing Temporary Tables {.smaller}
...
## Why Not Repeat the Query? {.smaller}
...
## Performance and Practical Considerations {.smaller}
...
## Temporary Tables vs. Subqueries {.smaller}
...
## What Are Filter Subqueries? {.smaller}
...
## Example from `Analytics Schema` {.smaller}
...
## Filter Subquery Using Another Table (Conceptual)  {.smaller}
...
## Subquery Using Another Table `Analytics Schema` {.smaller}
...
## What Is a Column Subquery?  {.smaller}
...
## When Column Subqueries Are Useful {.smaller}
...
## Why Column Subqueries Become Limiting {.smaller}
...
## What Is a Derived Table? {.smaller}
...
## When Derived Tables Are a Good Choice {.smaller}
...
## Why Derived Tables Become Limiting {.smaller}
...
## CTEs in the Analytical Workflow {.smaller}
...
## Why CTEs Improve Readability {.smaller}
...
## Business Question | Analytics Schema  {.smaller}
...
## Step-by-Step CTE Pipeline {.smaller}
...
## CTEs vs Other Constructs {.smaller}
...
## When CTEs Are the Right Choice {.smaller}
