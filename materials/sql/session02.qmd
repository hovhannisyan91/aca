...
::: {.callout-important title="Critical Terminology Clarification"}
...
::: {.callout-note title="DDL vs CRUD — Conceptual Comparison"}
...
::: {.callout-important title="Mental Model to Remember"}
...
You can revisit it here: [Session 3  DML Basics](session03.html)
