...
`CREATE` commands are used to define **new database objects**, such as tables or indexes.

Compared to other CRUD operations, `CREATE` is more complex because it requires you to explicitly define:
...
For more information about the index you can check the [Indexes](#indexes) section.


**Example: index on product category**
...
You can omit columns that have default values or allow `NULL`.
...
::: {.callout-tip}
[Here](https://dzone.com/articles/24-rules-to-the-sql-formatting-standard) you will find much more tips
:::
