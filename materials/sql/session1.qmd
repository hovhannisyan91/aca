...
6. Click on the connection and fill in: 
   ...
   2.  port `5432`
   3.  maintanance database: `aca`
   4.  username: `admin`
   5.  password: `password`
   ![](../../img/sql/pgadmin_4.png)
7. Navigate to in my case: $any_name \rightarrow aca \rgitharrow Schemas \rightarrow public \rightarrow Tables$
...
As soon as you finish the job related to the DB, remove the contaieners by typing
...
### Step 12: Everytime when re-runing 

We are going to  deactivate and activate constantly, thus you will get use to it. Dont worry :)
