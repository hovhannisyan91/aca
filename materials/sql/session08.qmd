...
Save the queries in a proper file similar to [this repository](https://github.com/hovhannisyan91/sql-analytics-portfolio/tree/main/queries) and push to **GitHub.**
...
3. Start thinking about the [final project](session13.qmd).
