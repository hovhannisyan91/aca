...
::: {.callout-important title = "**ROC Curve**"}
...
>The model AUC is `{python} round(auc_score, 3)`.

This means that the model has a `{python} round(auc_score * 100, 2)`% ability to rank a randomly selected churner higher than a randomly selected non-churner.
