...
::: {.callout-warning title = "__MACOSX"}
...
::: {.callout-important}
[Here](https://pandas.pydata.org/Pandas_Cheat_Sheet.pdf) you may find practically all the pandas functionality you are going to need for Data Analytics.
:::