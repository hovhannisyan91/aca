...
citibike_df['started_at'] = pd.to_datetime(df['started_at'])
citibike_df['ended_at'] = pd.to_datetime(df['ended_at'])
```
...
USA government provides an `API`
