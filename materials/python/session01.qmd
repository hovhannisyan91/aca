---
title: "Session 01: Programming for Data Analysts"
subtitle: "Why Programming for Data Analysts?"
categories: [Python, Intro]
image_path: "/img/python/01"
---

::: {.callout-important title = "Configure Python"}
Before starting the session, first lets try to install and configure the Python.

In order to do so checkout the [following tutorial here](https://hovhannisyan91.github.io/aca/materials/lab/python.html)
:::
...
![]({{< meta image_path >}}/organizing_projects.png)
...
![]({{< meta image_path >}}/navigating.png)
...
![]({{< meta image_path >}}/adding_cells.gif)
...
![]({{< meta image_path >}}/deleting_cells.gif)
...
![]({{< meta image_path >}}/markdown_sample.gif)
