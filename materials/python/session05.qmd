...
::: {.callout-note title = "Chart Chooser"}
Checkout the [this](https://public.tableau.com/app/profile/glowbyte.consulting/viz/ChartChooser_15550897459460/ChartChooser) dashbaord, which is going to help us to choose proper chart!
:::
...
More about data-ink [here](https://deliveringdataanalytics.com/the-data-to-ink-ratio-chart-makeover/?srsltid=AfmBOoo3LS46PezOCoxeMPjdggvjiV7vPvJyFrMk7n6TmDL6vMe6Rnsb)
:::
...
**Checkout the transformation of a chart with too much decoration into a cleaner version one more time:**

![.]({{< meta image_path >}}/14.gif)

::: {.callout-tip}
About [chartjunk](https://en.wikipedia.org/wiki/Chartjunk)
:::
...
The **Grammar of Graphics** is a powerful framework for understanding how charts are constructed. It breaks down a visualization into fundamental components.
...
For example, when we create a `scatter plot`, we are not simply choosing a chart type $\rightarrow$ we are making several decisions:
...
::: {.callout-important}
givent that the virtual environment is already set up, you can install `plotly` with the following command in your terminal:
...
Again, before creating a chart, answer three questions:
