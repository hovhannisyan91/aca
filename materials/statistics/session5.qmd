...
![]({{< meta image_path >}}/simple_random_sampling.png)
...
![]({{< meta image_path >}}/systematic_sampling.png)
...
![]({{< meta image_path >}}/stratified_sampling.png)
...
![]({{< meta image_path >}}/cluster_sampling.png)
...
![]({{< meta image_path >}}/resampling_sampling.png)

#### Simple Random vs Systematic vs Stratified vs Cluster

![]({{< meta image_path >}}/comparison_sampling.png)
...
Ignoring the correction would **overestimate** the sampling error and lead to
...
Suppose a national streaming analytics firm claims that **52% of U.S. households** watched a
...
is large enough to use the normal approximation to the binomial distribution. 
