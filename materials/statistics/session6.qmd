...
categories: [statistics, Hypothesis Testing, p-value]
image_path: "/img/statistics/06"
---
...
![]({{< meta image_path >}}/type_I_and_type_II.png)
...
#### Decision Rules  {#sec-hypothesis-testing-decision-rules}
...
###### Visual Representation {#sec-visual-representation-hypothesis-testing}
...
![]({{< meta image_path >}}/two_sample.png)
...
# Test statistic: B - A (aligned with H1: mu_B < mu_A)
t_stat = (xB - xA) / np.sqrt(sA**2/nA + sB**2/nB)
...
# FIX: align statistic with H1: mu_B < mu_A
t_stat = (xB - xA)/np.sqrt(sA**2/nA + sB**2/nB)
...
| **Left-Tailed**  | Does B *reduce* app load time vs A?              | $H_0:\mu_B\ge\mu_A$ <br> $H_1:\mu_B<\mu_A$                                  | $t=-4.37$      | $t_{0.05}=-1.645$                 | $p\approx 0.0000$  | Reject              | Version B **significantly reduces** app load time.                            |
