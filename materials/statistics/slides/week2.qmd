...
2. If the number of observations is odd → midfdle value.  
...
## Empirical Rule | Example 1 {.smaller}
...
## Empirical Rule | Example 2 {.smaller}
...
## Empirical Rule | Summary {.smaller}
...
## Chebyshev vs Empirical Rule {.smaller}
...
## Relative Positions | Percentiles {.smaller}
...
## Percentile Index Formula {.smaller}
...
- **Cause**: fire severity  
- Firefighters do **not** cause damage  
