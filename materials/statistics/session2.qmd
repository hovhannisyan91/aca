...
:::{.callout-note title = "Think about..."}
...
Let's calculate both `correlation` and `covariance` between `Hours of Study` and `Exam Grade` step by step.
