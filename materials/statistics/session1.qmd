...
subtitle: "What is Data Analytics, Data Layers, Types of Biases"
categories: [statistics]
image_path: "/img/statistics/01"
---
...
::: {.callout-important title="keyword"}
...
Without SSOT, organizations face inconsistent numbers, duplicated logic, and loss of trust in data.
With SSOT, data becomes a **strategic asset**, not a source of conflict.
...
- **Thinking with Data** – by Max Shron. [Download here](https://drive.google.com/file/d/11pVUnfU6lklIrGNwh2nKxQKBPEerQd_u/view?usp=drive_link)
- **Storytelling in Marketing** - by Caroline Florence [Downlaod here](https://drive.google.com/file/d/1hVeyAR_9Kuh9wwgj2APb6zsKJE18O-Xf/view?usp=drive_link)
...
![]({{< meta image_path >}}/selection_bias.png)
...
![]({{< meta image_path >}}/sampling_bias.png)
...
<!-- TODO  -->
![]({{< meta image_path >}}/survivorship_bias.png)
...
![]({{< meta image_path >}}/exclusion_bias.png)
...
![]({{< meta image_path >}}/confirmation_bias.png)
...
> [reading](https://en.wikipedia.org/wiki/Historical_bias)
...
As a junior data analyst, you probably won’t be asked to transform and load large amounts of raw data into a database; rather, you’ll be working with structured data which, after cleaning, will be ready for analysis. It’s easy to fall into the trap of believing that this data is objective, that it’s the raw truth, and that it can’t be spun or misinterpreted. If you were to believe these things, however, you’d be wrong.

Data is produced either by humans or by machines and algorithms that have been created by humans. In other words, data lends itself to human bias, which can lead to poor decision-making or the adoption of false beliefs. Fortunately, there’s a solution to this problem, and while it may not eliminate 100 percent of the analytical pitfalls of bias, it can help you see the truth you seek whenever you initiate a data analytics project. This solution is data ethics, and one of its guiding principles is transparency around the way data is sampled, tested, and processed.
 -->
