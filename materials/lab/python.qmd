...
![]({{< meta image_path >}}/download_page.png)
...
1. Download the Miniconda installer (`.exe`).
   ![]({{< meta image_path >}}/windows-install-miniconda-screen1.png)
2. Run the installer.
   ![]({{< meta image_path >}}/windows-install-miniconda-screen2.png)
3. During setup, enable:
   - **Add Miniconda to my PATH environment variable**
   - **Register Miniconda as the system Python**
   
   ![]({{< meta image_path >}}/windows-install-miniconda-screen3.png)
...
![]({{< meta image_path >}}/selected_kernel.png)
